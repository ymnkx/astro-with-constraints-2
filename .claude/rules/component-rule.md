---
paths: src/components/**/*.{astro,scss,ts}
---
# コンポーネント開発ルール

## 参考データ

- `src/components/Template/TemplateComponent.astro` - テンプレート
- `src/components/Template/TemplateComponent.scss` - スタイル
...
- `.claude/rules/css-rule.md` を参照すること。
